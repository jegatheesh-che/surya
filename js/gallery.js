...
const categoryAltText = {
  events: "Event ceremony and celebration photography by Surya Photography",
...
function getPhotoAltText(category) {
  return (
    categoryAltText[category] || `${category} photography by Surya Photography`
  );
}
...
const fallbackData = [
  {
    src: "assets/images/web/Copy%20of%20DSC00343.webp",
    category: "events",
    alt: "Event couple in a golden-hour outdoor portrait",
  },
  {
    src: "assets/images/web/Copy%20of%20DSC00602.webp",
    category: "portraits",
    alt: "Professional portrait session with natural light",
  },
  {
    src: "assets/images/web/DSC00147.webp",
    category: "maternity",
    alt: "Maternity portrait in a soft natural outdoor setting",
  },
  {
    src: "assets/images/web/DSC02092.webp",
    category: "lifestyle",
    alt: "Candid lifestyle moment captured by Surya Photography",
  },
];
